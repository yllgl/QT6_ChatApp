...
class MessageController : public BaseController {
    Q_OBJECT
public:
    MessageController(BaseController* parent,QUdpSocket* udpSocket):BaseController(parent){
        this->udpSocket = udpSocket;
        // udpSocket.bind(QHostAddress::AnyIPv4, 12345, QUdpSocket::ReuseAddressHint);
        connect(this->udpSocket, &QUdpSocket::readyRead, this, &MessageController::receiveMessage);
    };
